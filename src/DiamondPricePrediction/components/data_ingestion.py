...
import pandas as pd
import numpy as np
from src.DiamondPricePrediction.logging import logging
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            data=pd.read_csv(Path(os.path.join("C:/Users/OJAS/Downloads/playground-series-s3e8/train.csv")))
...
if __name__ == "__main__":
    ...
    arr=obj2.initialize_data_transformation(path[0],path[1])
    
    
    obj1 = ModelTrainer()
    
    obj1.initate_model_training(arr[0],arr[1])
    
    
    obj2 = ModelEvaluation()
    obj2.eval_metrics()
